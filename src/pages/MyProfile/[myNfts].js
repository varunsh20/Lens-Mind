...
import "../Profiles/nftStyles.css";
import {TailSpin} from 'react-loader-spinner';
import { toast } from "react-toastify";

export default function MyProfileNfts(){
    const {myNfts} = useParams();
        ...
        <div className="profileRight">
          <div className="postsType">
            <div className="tab">
              ...
              <Link to={`/myProfile/nfts/${myNfts}`} > My Nfts</Link>
              <Link to = {`/myProfile/mirrors/${myNfts}`}>My Mirrors</Link>
          ...
          <div className="detail">
            ...
            :
          <div  className="notfound"><h2>You have no Nft's yet.</h2></div>
          }
        </div>
