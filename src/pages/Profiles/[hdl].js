...
export default function ProfileMirrors(){
    const {hdl} = useParams();
      ...
      <div className="profile">
        ...
        <div className="profileRight">
          <div className="postsType">
            <div className="tab">
                <Link to = {`/profile/${hdl}`}>Posts</Link>
                <Link to={`/profile/nfts/${hdl}`} > Nfts</Link>
                <Link to = {`/profile/mirrors/${hdl}`}>Mirrors</Link>
            </div>
          </div>
          ...
          <>
            ...
            :
          <div  className="notfound"><h2>{p_data.profile.handle} has not mirrored anything yet.</h2></div>
          }
        </div>
        </div>
      </div>
